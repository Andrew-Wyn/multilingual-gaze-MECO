...
if __name__ == "__main__":
    ...
    compute_mean_baseline(args, "data/datasets/sp/all_mean_dataset.csv", "en_all")
    compute_mean_baseline(args, "data/datasets/sp/cluster_0_dataset.csv", "en_0")
    compute_mean_baseline(args, "data/datasets/sp/cluster_1_dataset.csv", "en_1")
    compute_mean_baseline(args, "data/datasets/sp/cluster_2_dataset.csv", "en_2")
